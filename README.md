...
## Our Approach
**Xeno CRM** replaces the dashboard with an **Agentic AI Assistant**. Simply type what you want in plain English: 
...
### Stark Editorial Design
- **Aesthetics First**: A stunning, modern UI built with Tailwind CSS featuring a Cohere-inspired stark editorial design language, using a curated canvas, soft stone, enterprise deep green, and premium royal indigo/purple accents, with elegant typography (`Space Grotesk`, `Inter`, `Space Mono`).
...
<br/>
<div align="center">
  <i>Built with love by Manveen</i>
</div>
